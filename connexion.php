...
<head>
    ...
    <script src="jsconnexion.js" defer></script>
</head>
...
<body class="h-screen">
    ...
    <div class="container">
        ...
        <?php 
        if (isset($_GET['resultat'])  && empty($_GET['resultat']) == 0) {
            $resultat = (int) $_GET['resultat'];
            ?>
            action="traitement_connexion.php?<?php echo 'resultat=' . $resultat; ?>"
            <?php
        }else {
            ?>
            action="traitement_connexion.php"
            <?php
        }
            ?> 
            method="post">
        ...
        <div class="group">
            ...
            <div>
                ...
                <input placeholder="E-mail" name="email" type="text" class="input" required>
            </div>
            ...
            <div>
                ...
                <input placeholder="Mot de passe" name="mot_de_passe" type="password" class="input" required>
            </div>

            <button type="submit" class="connect">Se connecter</button>

            <p class="register-link">Pas encore de compte ? <a href="inscription1.php">S'inscrire</a></p>
        </form>
    </div>
