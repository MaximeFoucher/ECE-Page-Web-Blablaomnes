...
<body class="h-screen">
    ...
    <h2>Quelle type de trajet préparez-vous ?</h2>
    <?php /*verifie si erreur=13*/
            if (isset($_GET['erreur'])  && empty($_GET['erreur']) == 0) {
                $erreur = (int) $_GET['erreur']; /*verifie si l'erreur existe*/
                if ($erreur == 13) {
            ?>
                    <br>
                    <p class="text-red-600 text-3xl text-center">Registrez vous comme conducteur afin de publier un trajet</p>
            <?php
                }
            }
            ?>
    ...
    <div  class="container">
        <div class="option" onclick="window.location.href='postertrajet.php'" id="aller-simple">
            <div class="option-text">Aller Simple</div>
            <div class="dfleche">
                <i class="fa-solid fa-arrow-right-long"></i>
            </div>  
        </div>

        <div onclick="window.location.href='postertrajetar.php'" class="option" id="aller-retour">
            <div class="option-text">Aller-Retour</div>
            <div class="dfleche">
