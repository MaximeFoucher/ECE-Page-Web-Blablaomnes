...
$(document).ready(function() {
    ...
    var balanceValue = parseFloat(balanceText.replace('€', '')); // Extraire la valeur numérique du solde

    if (balanceValue < 0) {
        $('#balance').addClass('balance-negative'); // Ajouter la classe pour solde négatif
    } else {
        $('#balance').addClass('balance-positive'); // Ajouter la classe pour solde positif
    }
});
