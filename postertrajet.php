...
<body class="h-screen">
    ...
    <div class="container">
        ...
        <form class="poster-form" action="traitement_postertrajet.php" method="post">

            <h2>Poster un trajet</h2>
            <?php /*verifie si erreur=10*/
            if (isset($_GET['erreur'])  && empty($_GET['erreur']) == 0) {
                $erreur = (int) $_GET['erreur']; /*verifie si l'erreur existe*/
                if ($erreur == 10) {
            ?>
                    <br>
                    <p class="text-red-600 text-3xl text-center">La date du trajet doit être correcte </p>
            <?php
                }
            }
            ?>
            ...
            <div class="group">
                ...
                <div class="lieu">
                    ...
                    <div class="input-container z-0 margin1">
                        <input type="text" name="depart" id="depart" placeholder=" " autocomplete="off" name="depart" required readonly>
                    ...
                    <div class="input-container z-0 margin2">
                        <input type="text" name="arrivee" id="arrivee" placeholder=" " autocomplete="off" name="arrivee" required>
                ...
                <div class="date">
                    <div class="input-container z-0 margin3">
                        <input class="dateInput" name="date" type="text" autocomplete="off" name="datealler" required>
                    ...
                    <div class="heure">
                        <div class="input-container z-0 margin3">
                            <input class="timeInput" type="text" autocomplete="off" name="heure" required>
                    ...
                    <div class="passager">
                        <div class="input-container z-0">
                            <input type="number" name="nb_passagers" autocomplete="off" min="1" required>
